...
public class SaveDrawing : MonoBehaviour
{
   ...
   // public Canvas imageGallery_Canvas;
    ...
    public string ScreenShotName(int width, int height)
    {
        ...
        savedPhoto = "Assets/Resources/SavedDrawings/" + "Sketch" + i + ".png";
        i++;
        return savedPhoto;
    ...
    public Sprite SaveImage(Camera camera)
    {
        ...
        //take the picture
        Texture2D ScreenCapture = new Texture2D(resWidth, resHeight, TextureFormat.RGB24, false);
        camera.Render();
        RenderTexture.active = hr;
        ScreenCapture.ReadPixels(new Rect(0, 0, resWidth, resHeight), 0, 0);
